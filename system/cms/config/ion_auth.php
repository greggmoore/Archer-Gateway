 ...
 */
$config['site_title']                 = 'Archer Gateway';       // Site Title, example.com
$config['admin_email']                = "gregg@blumoocreative.com"; // Admin Email, admin@example.com
$config['default_group']              = 'users';           // Default group, use name
$config['admin_group']                = 'supers';             // Default administrators group, use name
...
$config['email_config'] = array(
    ...
    'smtp_port' => 465,
    'smtp_user' => 'gregg.moore23@gmail.com',
    'smtp_pass' => '1965Chevy!!',
    'mailtype' => 'html',
    'charset' => 'iso-8859-1'
);
