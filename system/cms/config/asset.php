...
|
*/
$config['asset_dir_name'] = '/system/applications/';
...
|
*/
$config['asset_js_dir'] = 'assets/js/';
$config['asset_plugins_dir'] = 'assets/plugins/';
$config['asset_css_dir'] = 'assets/css/';
$config['asset_dir'] = '/system/cms/modules/themes/';
