<div class="row bg-title">
	...
	<div class="col-md-12">
		<ol class="breadcrumb pull-left">
			...
			<li><a href="/admin/community/edit/community"> Be Part of the Team</a></li>
			<li class="active">Quotes</li>
		</ol>
		
		<a class="btn btn-success pull-right" href="/admin/quotes/add">ADD NEW</a>
	</div>
</div>
	...
	<div class="col-md-12">
		<div class="white-box">
			<div class="table-responsive">
				<table id="quoteItems" class="table table-striped">
					<thead>
						<tr>
							<th>Author</th>
							<th>Quote</th>
					...
					<tbody>
						<?php if(isset($quotes)) echo $quotes; ?>
					</tbody>
					<tfoot>
						<tr>
							<td colspan="5">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <h4>Are you sure?</h4>
		<p>Deleting the <span class="modal-span-quotee"></span>'s quote will remove all related content from the database.</p>
      </div>
...
<div class="modal fade animated" id="myPublishModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
        <h3 class="modal-title" id="myModalLabel">Update/Publish quotes order</h3>
      </div>
      <div class="modal-body">
        <h4>Are you sure?</h4>
		<p>This will publish the current quptes order to the <strong>live</strong> site.</p>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
