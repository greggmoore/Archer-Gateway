			<div class="block">
              <div class="text-img-block">
                <img class="img-fluid" src="/<?php echo $this->template_path ; ?>/assets/images/electrostatic-precipitator-maintenance.jpg" alt="">
              </div>
              
              <div class="pt-lg-4">
                <?php if(isset($data->section1_title)) echo '<h1 class="sub-title mb-4">'.$data->section1_title.'</h1>'; ?>
              </div>
              <div class="row">
                <div class="col-md-12">
