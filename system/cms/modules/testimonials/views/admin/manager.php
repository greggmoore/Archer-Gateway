<div class="row bg-title">
	...
	<div class="col-md-12 col-xs-12">
		<ol class="breadcrumb pull-left">
			...
			<li><a href="/admin/patients-caregivers/edit/17"> Be Part of the Team</a></li>
			<li class="active">Patient Testimonials</li>
		</ol>
		<a class="btn btn-success pull-right" href="/admin/testimonials/add">ADD NEW</a>
	</div>
</div>
	...
	<div class="col-md-12">
		<div class="white-box">
			<div class="table-responsive">
				<table id="careerItems" class="table table-striped">
					<thead>
						<tr class="nodrop">
							<th>Quote</th>
...
<div class="modal animated" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <h4>Are you sure?</h4>
		<p>Deleting the story <span class="modal-span-title"></span> will remove all related content from the database.</p>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
