 ...
 * copyright Copyright (c) 2020, BLUMOOCREATIVE.COM
 */

// ------------------------------------------------------------------------

class Careers_m extends CI_Model
{
	...
	public function send_mail($array)
	{
		...
		$data = array(
			...
			'facebook' => $array['facebook'] ? $array['facebook'] : 'n/a' ,
			'telephone' => $array['telephone'] ? $array['telephone'] : 'n/a' ,
			'self_description' => $array['self_description'] ? $array['self_description'] : 'n/a' ,
			'project_experience' => $array['project_experience'] ? $array['project_experience'] : 'n/a' ,
			'skills_software' => $array['skills_software'] ? $array['skills_software'] : 'n/a' ,
			'resume_url' => $array['resume_url'] ? $array['resume_url'] : 'n/a' ,
		...
		**/
		...
		//$this->email->from('amandam@precip.com', 'WCI Careers');
		$this->email->to('amandam@precip.com');
		//$this->email->to('gregg@blumoocreative.com'); 
		//$this->email->bcc('devino@precip.com','danieln@precip.com','arleenh@precip.com','gregg@blumoocreative.com'); 
		$this->email->subject('WCI Careers');
		...
		if($this->email->send())
		{
			...
			if(STORE_CAREERS_DATA == 1)
			{
				//$this->db->replace($this->_careers_meta, $data);
