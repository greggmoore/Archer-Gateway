...
?>
					...
					<div class="row">
						...
						<div class="col-xl-10 offset-xl-1">
							<div class="hero-txt text-center white-color">
								...
								<h3>Blue Chip Transaction Services offers World Class Service!</h3>

								<!-- Text -->
								<p>Our goal is to take the bulk of the administrative tasks off your desk so you can turn your attention to more profitable and productive ventures in your business.</p>

								<!-- Button -->
								<a href="#about" class="btn btn-md btn-primary tra-white-hover">Discover More</a>
					...
					<div class="row d-flex align-items-center">
						...
						<div class="col-md-5 col-lg-6">
							<div class="img-block pr-25 mb-40 wow fadeInLeft" data-wow-delay="0.6s">
								<img class="img-fluid" src="/<?php echo $this->template_path ; ?>/assets/images/real-estate-home-for-sale.jpg" alt="about-image">
					 		</div>
						</div>
						...
						<!-- ABOUT TEXT -->
					 	<div class="col-md-7 col-lg-6">
					 		<div class="txt-block pc-25 mb-40 wow fadeInRight" data-wow-delay="0.4s">
					 			...
					 			<!-- Title -->	
								<h4 class="h4-xl darkblue-color">"You Can't Make a Six Figure Income Doing $10.00 an Hour Work!"</h4>
									...
									<div class="row">	
										...
										<div class="col-sm-6">					
											<div class="statistic-block">							
												...
												<p class="darkblue-color">Transactions Closed</p>
			...
			<!-- SERVICES-2
			============================================= -->
			<section id="services" class="bg-lightcyan wide-30 services-section division">
				<div class="container">
					...
					<div class="row">	
						<div class="col-lg-10 offset-lg-1 section-title wow fadeInUp" data-wow-delay="0.2s">	
							...
							<!-- Title 	-->	
							<h3 class="h3-lg darkblue-color">Our Services</h3>	

							<!-- Text -->	
							<p class="p-lg">Our service is unique to the industry, taking a sales transaction from contract to closing with a professional concierge styled transaction coordinator dedicated to you!  From the moment your sales contracts hits your transaction coordinators desk,  we will connect you with the lender, lawyer, co-broking real estate agent, vendors, and most importantly… your client.</p>
	 					...
	 					<div class="col-sm-6 col-lg-3">
	 						<a href="service-details.html">
		 						<div class="sbox-2 wow fadeInUp" data-wow-delay="0.4s">
		 							...
		 							<!-- Icon  -->
									<img class="img-85" src="/<?php echo $this->template_path ; ?>/assets/images/icons/computer-1.png" alt="feature-icon" />

									<!-- Title -->
									<h5 class="h5-md darkblue-color">Something Something</h5>
	 					...
	 					<div class="col-sm-6 col-lg-3">
	 						<a href="service-details.html">
		 						<div class="sbox-2 wow fadeInUp" data-wow-delay="0.8s">
		 							...
		 							<!-- Icon  -->
									<img class="img-85" src="/<?php echo $this->template_path ; ?>/assets/images/icons/computer.png" alt="feature-icon" />
					...
					<div class="row d-flex align-items-center">
						...
						<div class="col-md-7 col-lg-6">
							<div class="txt-block pc-25 wow fadeInLeft" data-wow-delay="0.4s">
					 			...
					 			<!-- Title -->	
								<h4 class="h4-xl darkblue-color">We Will Handle Everything.<br />Just Like You!</h4>

								<!-- Text -->
								<p>Our business model is built on the foundation of <strong>"World Class Service"</strong> and will relieve you from the painful and labor intensive tasks that do not generate revenue.</p>
								
								<p>In fact, we will design a customized plan of action, personalized by you, with a specific detailed checklist of tasks that you will create with your dedicated transaction coordinator.   Maintaining State compliance and brokerage compliance will always be our concern, with a pleasant, professional handling every detail of your transactions.</p>
						...
						<div class="col-md-5 col-lg-6">
							<div class="content-4-img wow fadeInRight" data-wow-delay="0.6s">
								<img class="img-fluid" src="/<?php echo $this->template_path ; ?>/assets/images/happy-people.jpg" alt="content-image">
							</div>	
						</div>
			...
			<!-- CALL TO ACTION-6
			============================================= -->
			<section id="cta-6" class="bg-darkblue bg-pattern cta-section division">
					...
					<div class="row">
						...
						<div class="col-md-12">
							<div class="cta-txt text-center">
								...
								<!-- Title -->	
								<h3 class="h3-lg">Cauliflower <span>CHEESEBURGER</span> babybel bocconcini!</h3>	

								<!-- Text -->	
								<p class="p-lg">Monterey jack cheesy feet fondue. Cheddar halloumi cheese and biscuits cheese strings hard cheese ricotta parmesan</p>
								...
								<div class="form-holder text-center">
									<form name="seoform" class="row seo-form">
										...
										<div id="input-email" class="col-lg-4">
											<input type="text" name="phone" class="form-control email" placeholder="Your Phone Number*"> 
										</div>


										<!-- Form Button -->
										<div class="col-lg-4 form-btn">	
											<button type="submit" class="btn btn-primary tra-white-hover submit">Contact Us Today!</button>	
										</div>
				...
				<div class="container">
					...
					<div class="row">	
						<div class="col-lg-10 offset-lg-1 section-title wow fadeInUp" data-wow-delay="0.2s">	
							...
							<!-- Title 	-->	
							<h3 class="h3-lg darkblue-color">Goat parmesan slices hard cheese</h3>	
			 			...
			 			<div class="row">
		 					...
		 					<div class="col-md-6">
		 						<div class="sbox-4 icon-md wow fadeInUp" data-wow-delay="0.4s">	
		 							...
		 							<!-- Icon --> 
									<img class="img-65" src="/<?php echo $this->template_path ; ?>/assets/images/icons/computer-1.png" alt="feature-icon" />

									<!-- Text -->
									<div class="sbox-4-txt">
		
										<!-- Title -->
										<h5 class="h5-lg darkblue-color">Something Something</h5>
					...
					<div class="row d-flex align-items-center">
						...
						<div class="col-md-5 col-lg-6">
							<div class="content-6-img mb-40 wow fadeInLeft" data-wow-delay="0.6s">
								<img class="img-fluid" src="/<?php echo $this->template_path ; ?>/assets/images/home-closed-family-agent.png" alt="content-image">
							</div>
						</div>
						...
						<div class="col-md-7 col-lg-6">
							<div class="txt-block pc-25 mb-40 wow fadeInRight" data-wow-delay="0.4s">
								...
								<!-- Text -->
								<p>There comes a point in every Real Estate professionals life where a decision has to be made.</p> 

								<h5 class="h5-md darkblue-color">Do I grow my business or do I continue "winging it?"</h5>
								
								<p>At Blue Chip Transaction Services our goal is to take the bulk of the administrative tasks off your desk so you can turn your attention to more profitable and productive ventures in your business.  Most top producing agents will agree that they spend far too much time working in their business instead of working on their business!</p>
								<p>We believe that the hyper-focused agent should be working on four fundamental tasks at all times, and delegate the minor duties to trained staff.  </p>
								
								<!-- Text -->
								<div class="cbox-1">	
					 				<i class="fas fa-check grey-color"></i>
									<div class="cbox-1-txt">
										<p>Attending Listing Appointments and Negotiate Transactions</p>
									</div>
								</div>
								...
								<div class="cbox-1">	
					 				<i class="fas fa-check grey-color"></i>
									<div class="cbox-1-txt">
										<p>Work With Only Qualified and Quantified Buyers</p>
									</div>
								</div>
								...
								<div class="cbox-1">	
					 				<i class="fas fa-check grey-color"></i>
									<div class="cbox-1-txt">
										<p>Network/Prospect For New Sources Of Business</p>
									</div>
								</div>
								...
								<div class="cbox-1">	
					 				<i class="fas fa-check grey-color"></i>
									<div class="cbox-1-txt">
										<p>Build, Maintain and Nourish a Salable Book of Business</p>
									</div>
								</div>
			...
			<!-- TEAM-1
			============================================= -->
			<section id="team" class="wide-60 team-section division">
				<div class="container">
					...
					<div class="row">	
						<div class="col-lg-10 offset-lg-1 section-title">	
							...
							<!-- Title 	-->	
							<h3 class="h3-lg darkblue-color">Meet Our Team</h3>	
						...
						<div class="col-md-6 col-lg-3 wow fadeInUp" data-wow-delay="0.4s">
							<div class="team-member">								
								...
								<div class="team-member-photo">
									...
									<img class="img-fluid" src="/data/uploads/profile-bob-percesepe.jpg" alt="team-member-foto">
								...
								<!-- Team Member Meta -->		
								<div class="tm-meta">
									<h5 class="h5-sm darkblue-color">Bob Percesepe</h5>
									<span>Founder</span>
									<a href="mailto:youremail@mail.com">bob@bluechiprealty.com</a>
								</div>	
			...
			<!-- STATISTIC-1
			============================================= -->
			<div id="statistic-1" class="bg-03 statistic-section division">
				<div class="container white-color">
					<div class="row">
						...
						<div class="col-sm-6 col-md-3">							
							<div class="statistic-block wow fadeInUp" data-wow-delay="0.4s">
								...
								<p class="p-md">Something something</p>																		
			...
			<section id="content-2" class="wide-60 content-section division">
				<div class="container">
					<div class="row d-flex align-items-center">
						...
						<div class="col-md-5 col-lg-6">
							<div class="img-block pr-25 mb-40 wow fadeInLeft" data-wow-delay="0.6s">
								<img class="img-fluid" src="/<?php echo $this->template_path ; ?>/assets/images/scheduling.jpg" alt="content-image">
							</div>
						</div>
						...
						<div class="col-md-7 col-lg-6">
							<div class="txt-block pc-25 mb-40 wow fadeInRight" data-wow-delay="0.4s">
								...
								<!-- Title -->	
								<h4 class="h4-xl darkblue-color">Pecorino pepper jack cheese triangles triangles</h4>
								...
								<!-- Button -->
								<a href="#pricing-1" class="btn btn-md btn-primary tra-black-hover">Contact Us</a>
						...
						<div class="col-xl-10 offset-xl-1">					
							<div class="owl-carousel owl-theme reviews-holder">
								...
								<div class="review-3">
									...
									<!-- Quote Icon -->
									<div class="quote-ico"><img src="/<?php echo $this->template_path ; ?>/assets/images/left-quote.png" alt="quote-image" /></div>
									...
									<div class="review-3-author d-flex align-items-center">
										...
										<div class="author-avatar">
											<img class="img-fluid" src="/<?php echo $this->template_path ; ?>/assets/images/review-author-1.jpg" alt="review-author-avatar" />
										</div> -->
								...
								<div class="review-3">
									...
									<div class="review-3-author d-flex align-items-center">
										...
										<!-- Author Avatar -->
										<div class="author-avatar">
											<img class="img-fluid" src="/<?php echo $this->template_path ; ?>/assets/images/review-author-2.jpg" alt="review-author-avatar" />
										</div>
								...
								<div class="review-3">
									...
									<div class="review-3-author d-flex align-items-center">
										...
										<!-- Author Avatar -->
										<div class="author-avatar">
											<img class="img-fluid" src="/<?php echo $this->template_path ; ?>/assets/images/review-author-3.jpg" alt="review-author-avatar" />
										</div>
								...
								<div class="review-3">
									...
									<div class="review-3-author d-flex align-items-center">
										...
										<!-- Author Avatar -->
										<div class="author-avatar">
											<img class="img-fluid" src="/<?php echo $this->template_path ; ?>/assets/images/review-author-4.jpg" alt="review-author-avatar" />
										</div>
								...
								<div class="review-3">
									...
									<div class="review-3-author d-flex align-items-center">
										...
										<!-- Author Avatar -->
										<div class="author-avatar">
											<img class="img-fluid" src="/<?php echo $this->template_path ; ?>/assets/images/review-author-5.jpg" alt="review-author-avatar" />
										</div>
								...
								<div class="review-3">
									...
									<div class="review-3-author d-flex align-items-center">
										...
										<!-- Author Avatar -->
										<div class="author-avatar">
											<img class="img-fluid" src="/<?php echo $this->template_path ; ?>/assets/images/review-author-6.jpg" alt="review-author-avatar" />
										</div>
								...
								<div class="review-3">
									...
									<div class="review-3-author d-flex align-items-center">
										...
										<!-- Author Avatar -->
										<div class="author-avatar">
											<img class="img-fluid" src="/<?php echo $this->template_path ; ?>/assets/images/review-author-7.jpg" alt="review-author-avatar" />
										</div>
								...
								<div class="review-3">
									...
									<div class="review-3-author d-flex align-items-center">
										...
										<!-- Author Avatar -->
										<div class="author-avatar">
											<img class="img-fluid" src="/<?php echo $this->template_path ; ?>/assets/images/review-author-8.jpg" alt="review-author-avatar" />
										</div>
				...
				<div class="container">
					...
					<div class="row">	
						<div class="col-lg-10 offset-lg-1 section-title wow fadeInUp" data-wow-delay="0.2s">
			 				...
			 				<!-- Title -->
							<h3 class="h3-lg darkblue-color">Frequently Asked Questions</h3>
								    ...
								    <div class="card-header" role="tab" id="headingTwo">
								      	<h5 class="h5-sm darkblue-color">
								       	    <a class="collapsed" data-toggle="collapse" href="#collapseTwo" role="button" aria-expanded="false" aria-controls="collapseTwo">
								          		Paneer lancashire cream cheese the big cheese?
								        	</a>
								     	 </h5>
								    </div>
					...
					<div class="row">
						<div class="col-md-12 text-center more-questions">
							<h5>Still have a question? <a href="/contact" class="primary-color">Ask your question here</a></h5>
						</div>
					</div>
