...
<div id="pending-status" class="row">
	...
	<div class="col-md-3 col-xs-12 moxie-btns">
		<a class="btn btn-warning" rel="external" href="/staging/about/leadership">REVIEW</a>
			...
			<div class="row">
				<div class="col-md-6">
					<div class="form-group" style="margin-bottom: 0;">
						<?php echo $this->team_m->category_select_menu(); ?>
					</div>
				</div>
			</div>			
		</div>
	...
	<div class="col-md-12">
		<div class="white-box">
			<div class="table-responsive">
				<table id="memberItems" class="table table-striped">
					<thead>
						<tr>
							<th>First</th>
