 ...
 *
 * @category	RhinoCMS\Core\Libraries\RhinoCache
 * @author		Gregg Mooore
 * @link		http://www.morestudios.com
 * @license		MIT
 * @version		2.3
 */
...
class Rhinocache
{
	...
	public function __construct()
	{
		...
		$this->_ci->load->config('rhinocache');
	...
	/**
	 * Use RhinoCache::model() or RhinoCache::library() instead of this.
	 *
	 * @see RhinoCache::model(), RhinoCache::library()
	 * @todo Document this function's parameters.
	 * @param $property
	 * @param $method
	 * @param array $arguments
	 ...
	 *
	 * <code>
	 * $this->rhinocache->write($data, 'nav_title');
	 * $this->rhinocache->write($links, 'nav_links');
	 * $this->rhinocache->delete_group('nav_');
	 * </code>
	 *
